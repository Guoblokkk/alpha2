...
saya Arulbot, bot ini adalah Beta Multi-Device Whatsapp.
`
}
exports.listMenu = (time, salam, pushname, prefix) => {
    return `*Selamat ${salam} ${pushname}*
*⌚Time Server : ${time}*
*🤖Grup Bot :* https://chat.whatsapp.com/GAuAnrTrjLlKhAUPoS5xM2
...
⚠️ Segala kebijakan dan ketentuan Arulbot di pegang oleh owner dan segala perubahan kebijakan, sewaktu waktu owner berhak mencabut, memblokir user(*﹏*) 

Arigatou Gozaimasu! Untuk kalian user ramah dan Beberapa orang yg ikut membantu juga dalam project pembuatan Arulbot
😖🙏
`
}
exports.welcome = () =>{
